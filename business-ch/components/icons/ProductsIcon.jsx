...
function ProductsIcon({ fill = "#bdbdbd", stroke= "#bdbdbd", ...rest }) {
  return (
    <svg width={24} height={24} viewBox="0 0 512 512" version="1.1" xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink">
    <g id="Page-1" stroke={stroke} stroke-width="1" fill={fill} >
        <g id="icon" fill={fill} transform="translate(64.000000, 34.346667)">
